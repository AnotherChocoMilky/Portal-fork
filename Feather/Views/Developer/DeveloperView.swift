...
struct NearbyShareUITestingView: View {
        ...
        ZStack {
            ...
            Group {
                ...
                case .nearbyPairingSender:
                    nearbyPairingSenderView
                case .nearbyPairingReceiver:
                    nearbyPairingReceiverView
                case .remotePairing:
                    remotePairingView
                case .transferProgress:
                    transferProgressMockView
                case .preflightCheck:
                    preflightCheckMockView
                case .postRestoreHealthCheck:
                    postRestoreHealthCheckMockView
                case .conflictResolver:
                    conflictResolverMockView
                }
            }
    ...
    private var loadingStateView: some View {
        ZStack {
            ...
            VStack(spacing: 20) {
                ...
                Text("Preparing Nearby Transfer...")
                    .font(.headline)
                    .foregroundStyle(.primary)
        ...
        ZStack {
            ...
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("The connection was interrupted. Please ensure both devices are on the same network and try again.")
                        .font(.body)
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)
                        .padding(.horizontal, 40)
        ...
        ZStack {
            ...
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Successfully transferred 1.2 GB of backup data")
                        .font(.body)
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)
                        .padding(.horizontal, 40)
    ...
    private var nearbyPairingSenderView: some View {
        ZStack {
            Color(UIColor.systemBackground).ignoresSafeArea()
            ...
            VStack(spacing: 32) {
                ...
                VStack(spacing: 16) {
                    ...
                    Text("Make sure the receiver is on the same Wi-Fi network")
                        .font(.subheadline)
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)
                        .padding(.horizontal, 40)
                ...
                VStack(spacing: 12) {
                    ...
                    ForEach(["iPhone 14 Pro", "iPad Pro", "iPhone 13"], id: \.self) { device in
                        HStack {
                            Image(systemName: "iphone")
                                .foregroundStyle(.blue)
                            Text(device)
    ...
    private var nearbyPairingReceiverView: some View {
        ZStack {
            Color(UIColor.systemBackground).ignoresSafeArea()
            ...
            VStack(spacing: 32) {
                ...
                VStack(spacing: 16) {
                    ...
                    Text("This device is visible to nearby senders on the same Wi-Fi network")
                        .font(.subheadline)
                        .foregroundStyle(.secondary)
                        .multilineTextAlignment(.center)
                        .padding(.horizontal, 40)
    ...
    private var remotePairingView: some View {
        ZStack {
            Color(UIColor.systemBackground).ignoresSafeArea()
            ...
            ScrollView {
                VStack(spacing: 32) {
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            instructionRow(number: 1, text: "Share this code with your other device")
                            instructionRow(number: 2, text: "On the other device, open Nearby Transfer")
                            instructionRow(number: 3, text: "Select 'Remote Pairing' and enter this code")
                            instructionRow(number: 4, text: "Wait for the connection to establish")
                        }
                    }
                    .padding(.horizontal, 40)
    ...
    private var transferProgressMockView: some View {
        ZStack {
            Color(UIColor.systemBackground).ignoresSafeArea()
            ...
            VStack(spacing: 40) {
                ...
                // Transfer details
                VStack(spacing: 16) {
                    detailRow(title: "Progress", value: "650 MB / 1.0 GB")
                    detailRow(title: "Speed", value: "5.0 MB/s")
                    detailRow(title: "Current", value: "SignedApps.zip")
                    detailRow(title: "Remaining", value: "1 min 10 sec")
                }
                .padding(.horizontal, 40)
            }
            .padding(.vertical, 80)
    ...
    private var preflightCheckMockView: some View {
        ZStack {
            Color(UIColor.systemBackground).ignoresSafeArea()
            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        VStack(spacing: 8) {
                            preflightItemRow(icon: "app.badge.fill", title: "Signed Apps", count: "12", size: "450 MB")
                            preflightItemRow(icon: "checkmark.seal.fill", title: "Certificates", count: "3", size: "2 MB")
                            preflightItemRow(icon: "globe.fill", title: "Sources", count: "5", size: "1 MB")
                            preflightItemRow(icon: "gearshape.fill", title: "Settings", count: "1", size: "< 1 MB")
                        }
                        .padding(.horizontal, 40)
                        
                        Text("Total Size: 453 MB")
                            .font(.caption)
                            .foregroundStyle(.secondary)
                            .padding(.horizontal, 40)
                    }
    ...
    private var postRestoreHealthCheckMockView: some View {
        ZStack {
            Color(UIColor.systemBackground).ignoresSafeArea()
            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 16) {
                        ...
                        VStack(spacing: 8) {
                            Text("Restore Complete")
                                .font(.title2)
                                .fontWeight(.bold)
                            Text("Health check: All systems operational")
                                .font(.subheadline)
                                .foregroundStyle(.secondary)
                        }
                    }
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        VStack(spacing: 8) {
                            healthCheckRow(icon: "app.badge.checkmark.fill", title: "Apps Verified", status: "12 of 12", color: .green)
                            healthCheckRow(icon: "checkmark.seal.fill", title: "Certificates Valid", status: "3 of 3", color: .green)
                            healthCheckRow(icon: "network", title: "Sources Active", status: "5 of 5", color: .green)
                            healthCheckRow(icon: "gearshape.fill", title: "Settings Applied", status: "Success", color: .green)
                        }
                        .padding(.horizontal, 40)
                    }
    ...
    private var conflictResolverMockView: some View {
        ZStack {
            Color(UIColor.systemBackground).ignoresSafeArea()
            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 16) {
                        ...
                        VStack(spacing: 8) {
                            Text("Conflicts Detected")
                                .font(.title2)
                                .fontWeight(.bold)
                            Text("Choose how to resolve duplicate items")
                                .font(.subheadline)
                                .foregroundStyle(.secondary)
                        }
                    }
                    ...
                    VStack(spacing: 16) {
                        conflictItemCard(
                            title: "Portal.ipa",
                            existingVersion: "v2.1.0",
                            incomingVersion: "v2.2.0",
                            icon: "app.badge.fill"
                        )
                        
                        conflictItemCard(
                            title: "Developer Certificate",
                            existingVersion: "Expires 2026",
                            incomingVersion: "Expires 2027",
                            icon: "checkmark.seal.fill"
                        )
                        
                        conflictItemCard(
                            title: "App Source",
                            existingVersion: "github.com/old",
                            incomingVersion: "github.com/new",
                            icon: "globe.fill"
                        )
                    }
                    .padding(.horizontal, 20)
    ...
    private func preflightItemRow(icon: String, title: String, count: String, size: String) -> some View {
        HStack {
            Image(systemName: icon)
                .foregroundStyle(.blue)
                .frame(width: 30)
    ...
    private func healthCheckRow(icon: String, title: String, status: String, color: Color) -> some View {
        HStack {
            Image(systemName: icon)
                .foregroundStyle(color)
                .frame(width: 30)
    ...
    private func conflictItemCard(title: String, existingVersion: String, incomingVersion: String, icon: String) -> some View {
        VStack(alignment: .leading, spacing: 12) {
            HStack {
                Image(systemName: icon)
                    .foregroundStyle(.orange)
