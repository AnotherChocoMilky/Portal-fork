...
struct HomeView: View {
    ...
    private let _tips = [
        ...
        "Tip: Check to see if you have the latest ChocoSign version by going to Settings, Check For Updates page so you can have the latest features and bug fixes.",
        ...
        "Tip: On a future update, you can import or export certificates as a .chococert file.",
        "Tip: Use Choco Transfer to import or export sources to other ChocoSign users.",
        "Tip: Swipe down on the Sources tab to refresh all repositories.",
